...
## Canonical Ironbar Documentation

This guide focuses on overview-mode behavior and service lifecycle.
For module internals, keep these as the source of truth instead of duplicating details here:

- `home-manager/nixos/ironbar/README.md` - architecture and module overview
- `home-manager/nixos/ironbar/CONFIG.md` - config layout notes
- `home-manager/nixos/ironbar/modules/volume/README.md` - volume module design
...
- `home-manager/nixos/ironbar/config.json` - bar layout
