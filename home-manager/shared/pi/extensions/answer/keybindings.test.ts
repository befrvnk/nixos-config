...
// Mirrors pi's keybindings manager contract: matches(data, keybindingId).
function createKeybindings(bindings: Record<string, string>): AnswerKeybindingsLike {
  return {
    matches(data, id) {
...
test("answer keybinding helpers respect injected keybinding ids", () => {
