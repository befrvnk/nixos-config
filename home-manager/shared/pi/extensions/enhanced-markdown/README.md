...
- Replaces raw-looking triple-backtick fences with a compact header/footer frame.
- Keeps the fence language in the block header.
- Avoids a left-side content border so terminal copy selections do not include decorative characters.
