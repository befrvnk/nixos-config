...
- Replaces raw-looking triple-backtick fences with compact horizontal separators.
- Keeps the fence language in the block header.
- Avoids side borders so terminal copy selections do not include decorative characters.
