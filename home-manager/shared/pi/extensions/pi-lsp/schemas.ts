...
export const LspQueryParams = Type.Object({
  ...
  line: Type.Optional(Type.Integer({ description: "1-indexed line number for hover/definition/references" })),
  character: Type.Optional(Type.Integer({ description: "1-indexed character number for hover/definition/references" })),
  ...
  maxResults: Type.Optional(Type.Integer({ description: "Maximum number of items to return", default: 50 })),
});
