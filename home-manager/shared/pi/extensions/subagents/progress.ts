...
export function extractLatestProgress(text: string): ProgressItem[] | undefined {
...
export function cleanParsedOutput(output: ParsedSubagentOutput): ParsedSubagentOutput {
  return {
